...
//servomotor shenanigans
int servolock = DIGITAL8;
int angle;
unsigned int us;
void servolockWrite(int servolock, int angle);
//
...
void loop()
{
  ...
  //servomotor void loop shenanigans
//  if( valuedoor >= 1)
//  {
//    servolockWrite(servolock, 90); //opens door 90 degrees
//    USB.printf("door opened.");
//  }
//  else if(valuedoor <= 1)
//  {
//    servolockWrite(servolock, 0); // closes door??
